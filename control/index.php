	...
	<body>
		...
		<div class="section">
			...
			<div class="image-container">
				<img src="../assets/img/iconosProductos//torres/img_torre2.png" alt="Imagen de torre" class="image">
			</div>
		...
		<div class="grid">
			<div class="item">
				<img src="../assets/img/iconosProductos/torres/1_tensores.png" alt="Tensor">
				<p class="description">TENSORES DE 5/8”</p>
			</div>
			<div class="item">
				<img src="../assets/img/iconosProductos/torres/2_grilletes.png" alt="Grillete">
				<p class="description">GRILLETES DE ½”</p>
			</div>
			<div class="item">
				<img src="../assets/img/iconosProductos//torres/3_performados.png" alt="Preformado">
				<p class="description">PREFORMADOS DE ¼</p>
			</div>
			<div class="item">
				<img src="../assets/img/iconosProductos//torres/4_cable.png" alt="Cable Acerado">
				<p class="description">CABLE ACERADO DE ¼</p>
			</div>
			<div class="item">
				<img src="../assets/img/iconosProductos//torres/5_tornillo.png" alt="Tornillo">
				<p class="description">TORNILLO DE 3/8 X 2 ½</p>
			</div>
			<div class="item">
				<img src="../assets/img/iconosProductos//torres/6_guardacabos.png" alt="Guardacabos">
				<p class="description">GUARDACABOS</p>
			</div>
			<div class="item">
				<img src="../assets/img/iconosProductos//torres/7_pararrayos.png" alt="Pararrayos">
				<p class="description">PARARRAYOS PUNTA FRANKLIN</p>
			</div>
			<div class="item">
				<img src="../assets/img/iconosProductos//torres/8_baliza.png" alt="Baliza">
