...
<style>
	...
	.slide4 {
		background-image: url('assets/img/banner/banner4.png');
	}

	.slide5 {
		background-image: url('assets/img/banner/banner5.png');
	}
	...
	@media (max-width: 992px) {
		.slide1 {
			background-image: url('banner_alargado-06.png');
		}
		.myslide.active {
			height: 500px;
		}
	...
	@media (max-width: 480px) {
		.imgfondo {
			content: url('banner_alargado-06.png');
			height: 50%;
			width: 100%;
			object-fit: cover;
			position: absolute;
