	...
	<body>
		...
		<div class="SistemaTierra" style="top: -75%;">
			<div class="content">
				<h1 class="TituloSitema">Exhibición y almacenaje </h1>
				<p class="paragraph">
					En Transformetal, diseñamos y fabricamos soluciones metálicas personalizadas para la industria de almacenaje y exhibidores.
					Nuestros productos combinan durabilidad, diseño eficiente y funcionalidad, garantizando un rendimiento óptimo para maximizar
					el espacio y mejorar la presentación de sus productos.
				</p>
			</div>
		</div>
		...
		<section class="productos">
			...
			<div class="grid">
				...
				<a href="../../public/products/almacenaje/index.php#Gondolas">
					<div class="producto">
						<img src="../../assets/img/iconosProductos/exhibicion/gondola.png" alt="Gabinetes">
						<p class="produc">Góndolas</p>
					</div>
				</a>
				<a href="../../public/products/almacenaje/index.php#estanterias">
					<div class="producto">
						<img src="../../assets/img/iconosProductos/exhibicion/estanteria.png" alt="Racks">
						<p>Estanterías</p>
					</div>
				</a>
				<a href="../../public/products/almacenaje/index.php#Rack_Industrial">
					<div class="producto">
						<img src="../../assets/img/iconosProductos/exhibicion/rackIndustrial.png" alt="Rieles">
						<p>Racks Industrial</p>
					</div>
				</a>
