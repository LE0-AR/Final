	...
	<body>
		...
		<div class="SistemaTierra" style="top: -75%;">
			<div class="content">
				<h1 class="TituloSitema">Telecomunicaciones e I.T </h1>
				<p class="paragraph">
					En el corazón de las telecomunicaciones y las tecnologías de la información, la metalmecánic
					desempeña un papel esencial al soportar y proteger la infraestructura que impulsa la
					conectividad global. Ofrecemos soluciones completas que abarcan desde gabinetes y racks para
					micro data centers hasta estructuras para ambientes indoor y outdoor, diseñadas para nodos
					de telecomunicaciones y salas IT.
				</p>
			</div>
		</div>
