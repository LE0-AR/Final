...
// Verificar si se recibió un ID y obtener datos del producto
if (isset($_GET['id'])) {
    $id = $_GET['id'];
...
// URL base para las imágenes y archivos, camboiarlos por la del dominio
$base_url = "http://localhost/transformetal/app/";
?>
...
<div class="container">
    ...
    <form method="POST" action="../Model/editarProduct.php" enctype="multipart/form-data">
        ...
        <!-- Botones para agregar/eliminar características -->
        ...
        <div id="caracteristicas">
            <?php
            // Consulta y muestra las características existentes
        ...
        <!-- Botones para agregar/eliminar especificaciones -->
        ...
        <div id="especificaciones">
            <?php
            // Consulta y muestra las especificaciones existentes
...
<script>
    // Función para agregar dinámicamente una nueva característica
    ...
    // Función para eliminar la última característica agregada
    ...
    // Función para eliminar la última especificación técnica agregada
    ...
    // Función para cargar las categorías manteniendo la selección actual
    function cargarCategorias(sectorSeleccionado, categoriaActual) {
        const selectCategoria = document.getElementById('categoria');
        // Limpiar opciones actuales
        selectCategoria.innerHTML = '<option value="" disabled>Seleccione una categoría</option>';
        ...
        if (categoriasPorSector[sectorSeleccionado]) {
            categoriasPorSector[sectorSeleccionado].forEach(categoria => {
                ...
                // Mantener la categoría que estaba seleccionada
    ...
    // Cargar categorías iniciales cuando se carga la página
    document.addEventListener('DOMContentLoaded', function() {
        const sectorActual = document.getElementById('sector').value;
        const categoriaActual = '<?php echo $producto['categoria']; ?>';
        cargarCategorias(sectorActual, categoriaActual);
    });

    // Actualizar categorías cuando cambie el sector
