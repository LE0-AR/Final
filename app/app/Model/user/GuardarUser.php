...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO productos (nombre, sector, categoria, descripcion, imagen_principal, ficha_tecnica, estado)
            VALUES ('$nombre', '$sector', '$categoria', '$descripcion', '$imagen_principal', '$ficha_tecnica', '$estado')";
    ...
    if ($connect->query($sql) === TRUE) {
        ...
        echo "<script>alert('Producto registrado correctamente'); window.location.href = '../../Views/user/ProductUser.php';</script>";
    } else {
        echo "<script>alert('Error al registrar el producto'); window.location.href = '../../Views/user/ProductUser.php';</script>";
    }
